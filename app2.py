...
def download_file(file_name, url):
    if not os.path.isfile(file_name):
        subprocess.run([f'curl --output {file_name} "{url}"'], shell=True)

def load_classifiers():
    # Download model files
    download_file('ResNet50V2_Binary.hdf5', 'https://drive.google.com/u/0/uc?id=19yQXM-v_Q0h9sQGdqmGgiDjkqXAj7pQG&export=download')
    download_file('ResNet50V2_MultiClass.hdf5', 'https://drive.google.com/u/0/uc?id=1-2oglfOHsJ8BsJ98q5b8xLBiytGM0ez3&export=download')
    download_file('ResNet101V2_Binary.hdf5', 'https://drive.google.com/u/0/uc?id=1-5r031ZBkGVitnuV4Xu8z0Hx2ZMwqWYT&export=download&confirm=t')
    download_file('ResNet101V2_MultiClass.hdf5', 'https://drive.google.com/u/0/uc?id=1-3SVUDHrKmV-dUz1uppdLrIoV_favOZt&export=download&confirm=t')
    download_file('ResNet152V2_Binary.hdf5', 'https://drive.google.com/u/0/uc?id=1-64EcLv277pWm4pfrlAeXLkygT2JIvKj&export=download&confirm=t')
    download_file('ResNet152V2_MultiClass.hdf5', 'https://drive.google.com/u/0/uc?id=1-4E8kBAFuoToexf_Nh1-i3MxQeQ7wC4D&export=download&confirm=t')
    download_file('weights_binary.npy', 'https://drive.google.com/u/0/uc?id=1C2X4worq9sGrBlURKLzqucDtDYQCvBA-&export=download')
    download_file('weights_MultiClass.npy', 'https://drive.google.com/u/0/uc?id=1-5zYystBU_xRA4iihAcRUqsU3EC5QUnm&export=download')
